...
#ifndef DIRICHLET_TRANSITION_SPARSE_H
#define DIRICHLET_TRANSITION_SPARSE_H
 ...
 */
class DirichletTransitionsSparse 
{
public:
	...
	DirichletTransitionsSparse(int n_states_, int n_actions_,
						 real prior_mass_ = 0.5, bool uniform_unknown_ = true);

	/// The destructor
	virtual ~DirichletTransitionsSparse();
