...
#ifndef DISCRETE_MDP_COUNTS_SPARSE
#define DISCRETE_MDP_COUNTS_SPARSE
 ...
 */
class DiscreteMDPCountsSparse : public MDPModel
{
public:
    enum RewardFamily {
        UNDEFINED=0x0,
...
*/	// copy constructor
	DiscreteMDPCountsSparse(const DiscreteMDPCountsSparse& model);
	// Clone
	virtual DiscreteMDPCountsSparse* Clone() const;
    virtual ~DiscreteMDPCountsSparse();
