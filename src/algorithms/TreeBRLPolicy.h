...
#ifndef TREE_BRL_POLICY_H
#define TREE_BRL_POLICY_H
 ...
 */
class TreeBRLPolicy : public OnlineAlgorithm<int, int>
{
public:
	enum LeafNodeValue {
...
public:
    ...
    {
    protected:
        TreeBRLPolicy& tree; ///< link to the base tree
        ...
        int t; ///< time
    public:
        BeliefState(TreeBRLPolicy& tree_,
