...
#ifndef TREE_BRL_POLICYAVG_H
#define TREE_BRL_POLICYAVG_H
 ...
 */
class TreeBRLPolicyAvg : public OnlineAlgorithm<int, int>
{
public:
	enum LeafNodeValue {
	...
	enum WhichAlgo {
		PLCAVG = 0x0, PLC, WRNGPLCAVG, FULL, SPARSE
	};
protected:
    ...
    DiscreteMDPCounts* belief; ///< pointer to the base MDP model
...
public:
    ...
    {
    protected:
        TreeBRLPolicyAvg& tree; ///< link to the base tree
		DiscreteMDPCounts* belief; ///< current belief
        ...
        int t; ///< time
    public:
        BeliefState(TreeBRLPolicyAvg& tree_,
    ...
    TreeBRLPolicyAvg(int n_states_, ///< number of states
            int n_actions_, ///< number of actions
            real gamma_, ///< discount factor
            DiscreteMDPCounts* belief_, ///< belief about the MDP
    ...
    */
    ...
    std::unordered_map < BeliefState* , std::vector<FixedDiscretePolicy*> > same_parent_policies;///< polcies sampled at the root
    TreeBRLPolicyAvg::BeliefState CalculateSparseBeliefTree(int n_samples, int n_TS);
    TreeBRLPolicyAvg::BeliefState CalculateBeliefTree();
    TreeBRLPolicyAvg::BeliefState CalculateSparserBeliefTree(int n_samples, int K_step, int n_TS);
