...
int main(int argc, char** argv) {
    ...
    int leaf_value = TreeBRL::LeafNodeValue::NONE;
...
//	    real epsilon = 0.01;
  //          SampleBasedRL* sampling = new SampleBasedRL(n_states,
    ...
    for (int experiment=0;
        ...
        real total_reward = RunExperiment(environment, tree, n_steps,randomizer);
                   ...
                   unordered_map<int,int> rotater )
{
	...
	//action = rotater[action];	//rotater should be implemented after creating environments
