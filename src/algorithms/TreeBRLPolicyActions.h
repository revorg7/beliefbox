...
#ifndef TREE_BRL_POLICY_ACTIONS_H
#define TREE_BRL_POLICY_ACTIONS_H
 ...
 */
class TreeBRLPolicyActions : public OnlineAlgorithm<int, int>
{
public:
	enum LeafNodeValue {
...
public:
    ...
    {
    protected:
        TreeBRLPolicyActions& tree; ///< link to the base tree
        ...
        int t; ///< time
    public:
        BeliefState(TreeBRLPolicyActions& tree_,
    ...
    TreeBRLPolicyActions(std::shared_ptr<DiscreteEnvironment> environment_,
    ...
    */
    ...
    TreeBRLPolicyActions::BeliefState CalculateSparseBeliefTree(int n_samples, int n_TS);
    TreeBRLPolicyActions::BeliefState CalculateBeliefTree();
    TreeBRLPolicyActions::BeliefState CalculateSparserBeliefTree(int n_samples, int K_step, int n_TS);
